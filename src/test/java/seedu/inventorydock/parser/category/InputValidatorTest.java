...
public class InputValidatorTest {
    ...
    public void validate_validInput_success() {
        String input = "category/FRUITS item/bread bin/0 qty/1 expiryDate/2026-03-20 isRipe/true";

        assertDoesNotThrow(() -> InputValidator.validate(input,
                "category/", "item/", "bin/", "qty/", "expiryDate/", "isRipe/"));
    }

    @Test
    public void validate_missingField_throwsException() {
        String input = "category/FRUITS item/bread bin/0 expiryDate/2026-03-20 isRipe/true";
    ...
    public void validate_duplicateQty_throwsException() {
        String input = "category/FRUITS item/bread bin/0 qty/1 qty/12301 expiryDate/2026-03-20 isRipe/true";
    ...
    public void validate_wrongOrder_throwsException() {
        String input = "category/FRUITS item/bread qty/1 bin/0 expiryDate/2026-03-20 isRipe/true";
