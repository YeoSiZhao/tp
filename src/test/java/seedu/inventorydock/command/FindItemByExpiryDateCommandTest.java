...
public class FindItemByExpiryDateCommandTest {
    ...
    @Test
    public void execute_matchingItems_showsAllItemsExpiringOnOrBeforeDate() throws InventoryDockException {
    ...
    @Test
    public void execute_noMatchingItems_showsNoItemsFoundMessage() throws InventoryDockException {
    ...
    @Test
    public void execute_doesNotMutateInventory_inventoryRemainsUnchanged() throws InventoryDockException {
    ...
    @Test
    public void execute_vegetableItemsIncludedWhenMatchingDate() throws InventoryDockException {
